...
# regard is polymorphic if major allele is below this threshold
VAR_SNP_RATE_MAX_PERCENTAGE?=80
VAR_POLY_RATE_TABLE?=$(MAP_DIR)/poly_rate

VAR_SNP_TABLE?=$(MAP_DIR)/var_snp_table
VAR_SNP_SIMPLE?=$(MAP_DIR)/var_snp_simple

VAR_DATASET1?=pre_lib_sg_simple
VAR_DATASET2?=post_lib_sg_simple
VAR_SNP_SIMPLE1?=$(call reval,VAR_SNP_SIMPLE,DATASET=$(VAR_DATASET1) MAP_SPLIT_TRIM=F)
VAR_SNP_SIMPLE2?=$(call reval,VAR_SNP_SIMPLE,DATASET=$(VAR_DATASET2) MAP_SPLIT_TRIM=F)
VAR_SNP_COMPARE?=$(MAP_DIR)/snp_compare
