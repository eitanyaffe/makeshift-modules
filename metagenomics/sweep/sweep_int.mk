...
# contig2bin table
SWP_CONTIG2BIN?=$(BINS_CONTIG_TABLE)
...
# output dirs
SWP_BASE_DIR?=$(ASSEMBLY_DIR)/sweep

# figures
SWP_BASE_FDIR?=$(BASE_FDIR)/sweep

#####################################################################################################
# compute contig-bin summary for a specific lib
#####################################################################################################

SWP_LIB_DIR?=$(SWP_BASE_DIR)/libs/$(LIB_ID)
...
SWP_CMP_DIR?=$(SWP_BASE_DIR)/$(SWP_CMP_LABEL)
