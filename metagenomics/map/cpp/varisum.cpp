...
void init_params(int argc, char **argv, Parameters& params)
{
  ...
  params.add_parser("ofn_nt_cov", new ParserFilename("output nt coverage table"), true);
  params.add_parser("ofn_link_cov", new ParserFilename("output link coverage table"), true);
...
int main(int argc, char **argv)
{
  ...
  save_tables(contig_map, nt_coord, total_nt, ofn_nt, ofn_nt_cov);
  save_tables(contig_map, link_coord, total_link, ofn_link, ofn_link_cov);
}
