...
# input fastq files
MAP_INPUT_PREFIX?=R
MAP_INPUT_SUFFIX?=fastq
MAP_PATTERN?=$(LIBRARY_DIR)/$(LIB_ID)/$(MAP_INPUT_PREFIX)*$(MAP_INPUT_SUFFIX)
...
# threads used while creating bam
MAP_SAMTOOLS_THREADS?=20

MAP_BAM_DIR?=$(MAP_DIR)/bam
MAP_BAM_FILE?=$(MAP_DIR)/merged.bam
