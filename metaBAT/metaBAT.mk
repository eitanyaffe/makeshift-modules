...
# TBD:
# split contigs into 1k segments
...
$(MB_INDEX_DONE): $(METABAT_INPUT_DONE)
...
$(METABAT_BAM_DONE): $(MB_INDEX_DONE)
	$(call _start,$(METABAT_LIB_DIR))
	$(METABAT_BWA) mem \
		-t $(METABAT_BWA_THREADS) \
		$(METABAT_INDEX_PREFIX) \
		$(METABAT_IN_R1) \
		$(METABAT_IN_R2) \
	| $(METABAT_SAMTOOLS) sort -@$(METABAT_SAMTOOLS_THREADS) -o $(METABAT_LIB_BAM) -
	$(_end_touch)
...
$(METABAT_DONE): $(METABAT_DEPTH_DONE)
	$(_start)
