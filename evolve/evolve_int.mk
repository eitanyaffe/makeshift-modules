...
# TBD:
# 1. compute distance to nearest neighbour fixated site
# 2. summary per core (2k 5k 10k 100k||inter)
# 3. plot 12 persistent cores
MKT_FIX_DIST?=$(MKT_DIR)/fix_distance
